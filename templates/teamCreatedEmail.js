          ...
          <td style="padding:22px 30px 0 30px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr>
                ...
                <td valign="middle">
                  <p style="margin:0;font-family:arial,helvetica,sans-serif;font-size:14px;color:#4a5568;line-height:1.6;">Submit your <strong style="color:#1a2e5a;">PPT (Max 6 Slides)</strong> before <strong style="color:#dc2626;">26 June 2026</strong>.</p>
                </td>
              </tr>
            </table>
          </td>
